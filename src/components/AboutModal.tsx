...
/**
 * A modal dialog that displays information about the "Kashef" application,
 * including its purpose, the development team, and a disclaimer.
 * The modal is fully accessible, handling focus trapping and keyboard events implicitly.
 *
 * @param {AboutModalProps} props The props for the component.
